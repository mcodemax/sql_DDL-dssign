...
--think how you'd design schema and how you'd insert data in an actual project
--declare all indep tables
--declare all dep tables
--insert indep data tables
--insert dep data into tables

--in an app make an initial data dummy sql file to insert dummy data
...
(
  id SERIAL PRIMARY KEY,
  name TEXT NOT NULL
  --maybe make a 3rd id for type of thing orbited; like star or planet
);
